...
def text_to_speech(text):
    ...
    response = client.text_to_speech.convert(
        voice_id="pNInz6obpgDQGcFmaJgB", #clone your voice on elevenlabs dashboard and copy the id
...
if __name__ == "__main__":
    ...
    # sk_12e74b0aef81fd293dcd58d274ac3adf6603a20ef04156fc
    # db8029e794fb4f2fbe156b9e9b99fea4
